        ...
        if(((moving.color == Piece::White && source.getRow() == Square::rowToInt(2)) || (moving.color == Piece::Black && source.getRow() == Square::rowToInt(7)))
           && movedX == 0 && movedY == 2 && this->game.board[destiny.getCol()*8+destiny.getRow()] == nullptr)
            return true;
                                                ...
                                                (source.getRow() == Square::rowToInt(5) && moving.color == Piece::White && this->game.board[destiny.getCol()*8+destiny.getRow()+1] != nullptr && this->game.board[destiny.getCol()*8+destiny.getRow()+1]->type == Piece::Pawn && this->game.board[destiny.getCol()*8+destiny.getRow()+1] == this->game.pawn_double_moved_last_turn) ||
                                                (source.getRow() == Square::rowToInt(4) && moving.color == Piece::Black && this->game.board[destiny.getCol()*8+destiny.getRow()-1] != nullptr && this->game.board[destiny.getCol()*8+destiny.getRow()-1]->type == Piece::Pawn && this->game.board[destiny.getCol()*8+destiny.getRow()-1] == this->game.pawn_double_moved_last_turn)))
            return true;
...
GameUI::GameUI(GameController& new_game): game(new_game), moving_piece(nullptr), last_square(nullptr)
{
